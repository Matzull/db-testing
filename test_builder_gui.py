...
class SqlTestBuilderInteractive:
    ...
    def create_tests_gui(self):
        ...
        style.theme_use(
            "clam"
        )  # Utilizar el tema "xpnative" para un aspecto más moderno
        ...
        # Función para cargar las columnas cuando se selecciona una tabla
        def load_columns():
        ...
        column_combobox = ttk.Combobox(
            frame, values=self.get_columns(selected_table.get())
        )
    ...
    def add_test(self, test_type, table, column):
